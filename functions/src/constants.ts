...
export const IMAGES_BUCKET = 'football-platform-images-bucket';
export const THUMBNAILS_BUCKET = 'football-platform-thumbnails-bucket';
export const IMAGES_STORAGE_PATH = { player: 'images/players' };
export const THUMBNAILS_STORAGE_PATH = { player: 'thumbnails/players' };
