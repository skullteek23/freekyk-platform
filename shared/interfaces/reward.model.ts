...
export const RewardMessage = {
  ...
  [RewardableActivities.openNotification]: 'opening your first notification',
  [RewardableActivities.requestMatch]: 'requesting your first match',
  [RewardableActivities.joinPickupGame]: 'joining your first pickup game',
