...
export const GROUND_FIELD_TYPES = ['FG', 'SG', 'HG', 'AG', 'TURF'];
export const GROUND_OWN_TYPES = ['FK', 'PUBLIC', 'PRIVATE'];
export const GROUND_PLAY_CONDITION = ['good', 'best', 'fair'];
export const STRONG_FOOT = ['L', 'R'];
